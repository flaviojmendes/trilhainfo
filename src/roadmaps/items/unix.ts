...
export const unix: RoadmapItem = {
  label: 'UNIX',
  description:
    'UNIX é um sistema operacional portável, multitarefa e multiusuário originalmente criado por Ken Thompson, Dennis Ritchie, entre outros, que trabalhavam nos Laboratórios Bell da AT&T.',
  children: [
    {
      label: 'AIX',
      links: [
