...
export const javascript: RoadmapItem = {
  ...
  children: [
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          ...
          label: 'Manipulação de DOM com JavaScript, do zero, na prática - Mayk Brito',
          contentType: LinkContentType.WATCH,
        },
        {
          url: 'https://www.computersciencemaster.com.br/exercicio-manipulacao-dom-javascript/',
          label: 'Exercícios de manipulação do DOM usando Javascript - Vinicius dos Santos',
          contentType: LinkContentType.PRACTICE,
        },
        {
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          ...
          label: 'Aprenda Fetch Api de Javascript - Matheus Battisti (Hora de Codar)',
          contentType: LinkContentType.WATCH,
        },
        {
    ...
    {
      label: 'Conceitos de Hoisting, Event Bubbling, Escopo, Prototype, Shadow DOM, strict',
      links: [
        {
