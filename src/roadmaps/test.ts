...
export const data: Level[] = [
  {
    ...
    description:"Esse é o básico. Aprendendo esses conceitos você será capaz de identificar um erro, defeito ou falha.",
    items: [
      {
        label: "O que é teste?",
        children: [
            ...
            links: [
              {
                ...
                label:
                  "TESTE DE SOFTWARE: O que é teste de software? - Julio de Lima",
            ...
            links: [
              {
                ...
                label:
                  "O que é Teste de Software? Por que é necessário? - CWI",
            ...
            links: [
              {
                ...
                label:
                  "7 motivos para considerar o teste de software indispensável - Umbler",
                contentType: LinkContentType.READ,
              },
            ],
          },
            ...
            links: [
              {
                ...
                label:
                  "7 PRINCÍPIOS DE TESTES DE SOFTWARE | by Syllabus - Assert+",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
            ...
            links: [
              {
                ...
                label:
                  "Erro X Defeito X Falha | Entenda a diferença - Qualicode Tech Academy",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
            ...
            links: [
              {
                ...
                label:
                  "O que significa CAUSA RAIZ em testes de software - Mauro de Boni",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
            ...
            links: [
              {
                ...
                label: "Teste de Unidade, Teste de Integração, Teste de Sistema, Teste de Aceite - Assert+ ",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
  ...
  },
  {
    ...
    description: "Conhecer cada abordagem de teste nos ajuda a saber qual tipo de teste utilizar na camada em que estamos testando",
    items: [
      {
            ...
            links: [
              {
                ...
                label: "Tabela de decisão no mundo dos testes por Vanessa Redes e Jonathan Santiago - 4All tests",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
            ...
            links: [
              {
                ...
                label: "Análise do valor limite: Conheça essa técnica de testes de software - Mauro de Boni",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
            ...
            links: [
              {
                ...
                label:"Testes Funcionais E Testes não funcionais - Entendo as diferenças | Exemplos de utilização - Assert+",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
  ...
  },
  {
    ...
    description: "Conhecer e ter uma boa ferramenta de gestão de testes pode te ajudar a prover um feedback sobre o ciclo de vida do software",
    items: [
      {
        label: "qTest",
        children: [
            ...
            links: [
              {
                ...
                label:"A solução de software projetada para impulsionar o desenvolvimento de software - Bugzilla",
                contentType: LinkContentType.READ,
              },
            ],
          },
            ...
            links: [
              {
                ...
                label:"Modelo em Cascata - Ciclos de Vida de Desenvolvimento de Software - Bóson treinamentos",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
  ...
  },
  {
    ...
    description: "Automação é uma técnica de teste de software que utiliza ferramentas especiais de teste automatizado para executar um conjunto de casos de teste, complementando assim a execução dos testes planejados",
    items: [
      {
        label: "Web",
        children: [
            ...
            links: [
              {
                ...
                label:"Detox Framework: Automação de testes saudável para apps em React Native - DevelopersBr",
                contentType: LinkContentType.WATCH,
              },
            ],
          },
