  ...
  return (
    <MainLayout>
      <div className="flex flex-col">
        ...
        {!isAuthenticated && (
          <div>
            <h2 className="mx-auto mt-2 w-fit text-xl text-yellow">
              {' '}
              Você precisa <span className="text-red">fazer login</span> para acessar essa página.
            </h2>
          </div>
        )}
        ...
        {isAuthenticated && (
          <div className="flex flex-col">
            <h2 className="mx-4 text-yellow md:mx-auto">{certification?.description}</h2>

            <h2 className="mx-4 mt-2 text-yellow md:mx-auto">
              Acerte <span className="text-red">75% ou mais</span> para ganhar a certificação.
            </h2>
            ...
            {!submitting && !loading && selectedQuestions && (
              <>
                {/* Progress Bar */}
                <div className="relative mx-2 mt-4 flex h-12 rounded-md bg-light-brown p-2 shadow-brutalist-light md:mx-auto md:w-1/2">
                ...
                <div className="mx-2 mt-4 flex flex-col rounded-md bg-brown p-2 shadow-brutalist-light md:mx-auto md:w-1/2 md:p-4">
                ...
                <div className="mx-2 mt-6 flex md:mx-auto md:w-1/2">
                  {currentQuestion > 0 && (
                    <button
